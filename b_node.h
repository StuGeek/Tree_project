...
public:
	...
	inline void set_key(float key, int index) { key_[index] = key; }
...
public:
	...
	// 新加的
	inline void set_son(int son, int index) { son_[index] = son; }
...
public:
	...
	// 新加的
	inline void set_id(int id, int index) { id_[index] = id; }

	inline int get_capacity_keys() { return capacity_keys_; }

	inline void set_num_keys(int num_keys) { num_keys_ = num_keys; }
